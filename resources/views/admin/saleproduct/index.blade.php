      ...
      <div class="col-12">
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            @if(isset($edit))
            <form action="{{route('saleproduct.update', $edit->id)}}" method="post" class="row" enctype="multipart/form-data">
              @method('PUT')
              @csrf
              @else

              <form action="{{route('saleproduct.store')}}" method="post" class="row" enctype="multipart/form-data">
              @csrf
              @endif
                ...
                <div class="offset-11 col-1 float-right">
